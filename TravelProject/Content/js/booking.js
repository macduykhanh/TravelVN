...
//        $.ajax({
//            type: 'POST',
//            data: { ma: _manlh, ten: _tennlh, email: _emailnlh, diachi: _diachinlh, dienthoai: _dtnlh, note: _notenlh },
//            url: '/BillTour/CapnhatTTNLH',
...
//        $.ajax({
//            type: 'POST',
//            data: { manlh: _manlh, mangten: JSON.stringify(listnamekh), mangdiachi: JSON.stringify(listadrkh), mangloai: JSON.stringify(listtypekh), manggt: JSON.stringify(listsexkh), mangngay: JSON.stringify(listnskh), soluong: lisNameKH.length },
//            url: '/BillTour/CapnhatKH',
//            success: function (result) {
//                //alert('successkh')
//            },
//            error: function (e) {
...
//        $.ajax({
//            type: 'POST',
//            data: { maphieutour: _maphieutour, pickupplace: Pickupplace, matour: Matour, gia: Tonggia },
//            url: '/BillTour/CapnhatPhieuDatTour',
//            success: function (result) {
